...
# @register_model
# def graphconvnet_b(pretrain=False,**kwargs):
#     model = GraphConvNet(
#         channels=640,
#         n_blocks=16,
#         k=9,
...
def graphconvnetp_s(pretrained=False,**kwargs):
    ...
    return model
# @register_model
# def graphconvnetp_m(pretrained=False,**kwargs):
#     model = GraphConvNet_p(
#         k=9,  # neighbor num (default:9)
#         gconv='mr',  # graph conv layer {edge, mr}
#         channels=[96, 192, 384, 768],  # number of channels of deep features
...
#     return model
# @register_model
# def graphconvnetp_b(pretrained=False,**kwargs):
#     model = GraphConvNet_p(
#         k=9,  # neighbor num (default:9)
#         gconv='mr',  # graph conv layer {edge, mr}
